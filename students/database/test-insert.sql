...
insert into student (card_number, first_name, last_name) values ('ra4-2014', 'Dejan', 'Dejanović');
insert into student (card_number, first_name, last_name) values ('ra5-2014', 'Jelena', 'Marković');
insert into student (card_number, first_name, last_name) values ('ra6-2014', 'Milica', 'Petrović');
insert into student (card_number, first_name, last_name) values ('ra7-2014', 'Igor', 'Jovin');
insert into student (card_number, first_name, last_name) values ('ra8-2014', 'Petar', 'Petrović');
insert into student (card_number, first_name, last_name) values ('ra9-2014', 'Zoran', 'Zoranović');
insert into student (card_number, first_name, last_name) values ('ra10-2014', 'Milana', 'Perić');
insert into student (card_number, first_name, last_name) values ('ra11-2014', 'Vesna', 'Stanić');
insert into student (card_number, first_name, last_name) values ('ra12-2014', 'Zorana', 'Jovin');
